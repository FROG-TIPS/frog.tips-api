...
endpoint = Blueprint('gary', __name__, url_prefix='/~GARY', template_folder='gary/templates', static_folder='gary/static', static_url_path='/static/gary')
...
def frog_manual():
    ...
    return render_template('das_ist_mein_frog.html', tips=tips)
